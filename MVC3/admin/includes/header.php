            ...
            <div class="container ">
                ...
                <div class="collapse navbar-collapse justify-content-end ml-auto align-content-middle">
                    <ul class="nav navbar-nav d-flex ">
                        ...
                        <?php }else{ ?>
                        <li class="nav-item align-self-center"><a class="nav-link" href="index.php"><button class="btn-header-colored">Login</button></a></li>
                        <?php }
								}else{ ?>
                        <li class="nav-item align-self-center"><a class="nav-link" href="index.php"><button class="btn-header-colored">Login</button></a></li>
                        <?php } ?>
                ...
                <div id="mobile-nav">
                    ...
                    <div id="mobile-nav-content">
                        <ul class="">
                            ...
                            <li class="dropdoen-item"><a class="" href="index.php"><button class="btn-header-colored">Logout</button></a></li>
                        </ul>
                    </div>
                </div>
