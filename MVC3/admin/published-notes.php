...
<body>
	...
	<div class="we-wrapper" id="published-notes">
		<!-- Header -->
						...
						<form>
							<div class="form-group">
								...
								<div class="styled-select1 form-select">
									<select name="users.fname" id="seller" class="form-control searchMeInTable">
										<option value="">Select Seller</option>
										<?php 
                                            $query="SELECT DISTINCT fname FROM users JOIN note ON users.user_id=note.user_id WHERE note.status_id=3 AND users.is_active=1";
