					...
					<table id="dashbord1" class="table  my-tables paginated">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="img/icons/edit.png" onclick="window.location.href = 'admin-add-type.php?id=<?php echo $row['type_id']; ?>';" class="img-responsive pr-2"><img src="img/icons/delete.png" onclick="window.location.href = 'process/deleteType.php?id=<?php echo $row['type_id']; ?>';" class="img-responsive"></td>
							</tr>
							<?php $i++; }?>
						</tbody>
					</table>
