<?php
    ...
    $msg = '';
    if(isset($_POST['add_profile']) && !empty($_POST['fname']) && !empty($_POST['lname']) && !empty($_POST['email']) && !empty($_POST['email2']) && !empty($_POST['phone']) && !empty($_POST['phone-number']) && isset($_FILES['profile_pic'])){
