...
<?php include "process/connection.php";
   ob_start();
    ...
    $query1="SELECT title,note.created_date,status.status,category.name,price,note.is_paid,note.status_id FROM note  JOIN category ON note.category_id=category.category_id JOIN status ON note.status_id = status.status_id WHERE user_id = '$user' ORDER BY note.created_date DESC";
                            ...
                            <form action="dashboard.php" method="post">
                                <div class="form-group ">
                                    <span class=" search-me">
                                        ...
                                        <input type="text" name="search_progress" class=" search-me form-search" placeholder="Search" />
                                    </span>
